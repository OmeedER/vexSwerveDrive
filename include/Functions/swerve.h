...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="command palette" role="dialog" aria-modal="true">
    ...
    <button aria-keyshortcuts="Control+Backspace" data-action="click:command-palette-input#onClear keypress:command-palette-input#onClear" data-target="command-palette-input.clearButton" id="command-palette-clear-button" hidden="hidden" type="button" data-view-component="true" class="btn-octicon command-palette-input-clear-button" aria-labelledby="tooltip-1674169550779-1306">      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x-circle-fill">
    <path fill-rule="evenodd" d="M2.343 13.657A8 8 0 1113.657 2.343 8 8 0 012.343 13.657zM6.03 4.97a.75.75 0 00-1.06 1.06L6.94 8 4.97 9.97a.75.75 0 101.06 1.06L8 9.06l1.97 1.97a.75.75 0 101.06-1.06L9.06 8l1.97-1.97a.75.75 0 10-1.06-1.06L8 6.94 6.03 4.97z"></path>
</svg>
</button>    <tool-tip for="command-palette-clear-button" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute" id="tooltip-1674169550779-1306" aria-hidden="true" role="tooltip">Clear Command Palette</tool-tip>
</div>
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay="">
  ...
  <div data-view-component="true">            <ul class="dropdown-menu dropdown-menu-sw">
              <li class="d-block d-md-none">
                ...
                <li><!-- '"` --><!-- </textarea></xmp> --><form data-turbo="false" action="https://github.com/OmeedER/Vex_Swerve_Drive/new/main/SwerveDrive/src/Functions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="vTAhJW5rrxYgYA7Vx62HUI-W7FxbgSjLN-hg2yg0WZn4IOB5OoHe5NvsL8H9DPO-0xMHsDY3gpf0-VfTNwNrQA">
  ...
  Upload files
                ...
                <li class="d-block d-md-none dropdown-divider" role="none"></li>
                <li class="d-block d-md-none">
                  <!-- '"` --><!-- </textarea></xmp> --><form data-turbo="false" action="https://github.com/OmeedER/Vex_Swerve_Drive/tree/delete/main/SwerveDrive/src/Functions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="b7jIvpV82VVzRiBYbSUQXTVL0JVrZGogbjpBpQaWPumhP9gPYYopdJKslC09Nwt7oqh3vL2gjGKVncVBlXMQXA">
  ...
  <div data-view-component="true">              <ul class="dropdown-menu dropdown-menu-sw">
                <li class="d-none d-md-block">
                  <!-- '"` --><!-- </textarea></xmp> --><form data-turbo="false" action="https://github.com/OmeedER/Vex_Swerve_Drive/tree/delete/main/SwerveDrive/src/Functions" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="i3E1ajFVD7Nw7N00omu5Pf4YKqVabKBgvteaHHiZsmlF9iXbxaP_kpEGaUHyeaIbafuNjIyoRiJFcB7463yc3A">
    <button type="submit" data-view-component="true" class="dropdown-item menu-item-danger btn-link">    Delete directory
</button></form>
                </li>
              </ul>
